...
class UsagePurposeAdapter(
    ...
    class ViewHolder(itemRowBinding: BbconsentItemUsagePurposeBinding) :
        ...
        fun bind(purposeConsent: PurposeConsent?, mListener: UsagePurposeClickListener) {
            ...
            itemRowBinding.ctvStatus.text = if (purposeConsent?.count?.consented == 0) itemRowBinding.ctvStatus.context
                .resources
            ...
            itemRowBinding.switchButton.setOnCheckedChangeListener { view, isChecked ->
