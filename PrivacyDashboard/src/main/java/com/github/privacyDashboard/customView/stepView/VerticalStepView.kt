...
class VerticalStepView @JvmOverloads constructor(
    ...
    private var mUnComplectedTextColor =
        ContextCompat.getColor(getContext(), R.color.bb_consent_stepview_uncompleted_text_color) //定义默认未完成文字的颜色;
    private var mComplectedTextColor =
        ContextCompat.getColor(getContext(), R.color.bbConsentWhite) //定义默认完成文字的颜色;
